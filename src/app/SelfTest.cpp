...
bool runExportTest() {
  ...
  {
    const ExportResult enc = exportDocument(ramp, ExportFormat::Png,
  ...
  // apart at all; at 16 bits they are codes 32833 and 32964, 131 apart.
  {
    ...
    const ExportResult e8 = exportDocument(pair, ExportFormat::Png,
                                           ExportTargetSpace::Rec709Srgb,
                                           ExportBitDepth::Eight);
    const ExportResult e16 = exportDocument(pair, ExportFormat::Png,
                                            ExportTargetSpace::Rec709Srgb,
                                            ExportBitDepth::Sixteen);
  ...
  {
    const ExportResult jpeg16 = exportDocument(ramp, ExportFormat::Jpeg,
                                               ExportTargetSpace::Rec709Srgb,
                                               ExportBitDepth::Sixteen);
    ...
    const ExportResult tga16 = exportDocument(ramp, ExportFormat::Tga,
                                              ExportTargetSpace::Rec709Srgb,
                                              ExportBitDepth::Sixteen);
    check(!tga16.ok && contains(tga16.error, "TGA"), "B6: 16-bit into TGA fails by name");
    const ExportResult bmp16 = exportDocument(ramp, ExportFormat::Bmp,
                                              ExportTargetSpace::Rec709Srgb,
                                              ExportBitDepth::Sixteen);
    ...
    const ExportResult png16 = exportDocument(ramp, ExportFormat::Png,
                                              ExportTargetSpace::Rec709Srgb,
                                              ExportBitDepth::Sixteen);
  ...
  // selectable -------------------------------------------------------------
  {
    ...
    const ExportResult lin = exportDocument(mid, ExportFormat::Png,
                                            ExportTargetSpace::Rec709Linear,
                                            ExportBitDepth::Sixteen);
    const ExportResult srgb = exportDocument(mid, ExportFormat::Png,
                                             ExportTargetSpace::Rec709Srgb,
                                             ExportBitDepth::Sixteen);
    const ExportResult r709 = exportDocument(mid, ExportFormat::Png,
  ...
  // premultiplied storage --------------------------------------------------
  {
    ...
    const ExportResult enc = exportDocument(alpha, ExportFormat::Png,
                                            ExportTargetSpace::Rec709Linear,
                                            ExportBitDepth::Sixteen);
  ...
  // --- The primaries scope decision, enforced rather than documented-only -
  {
    ...
    const ExportResult enc = exportDocument(wide, ExportFormat::Png,
                                            ExportTargetSpace::Rec709Srgb,
                                            ExportBitDepth::Sixteen);
    ...
    check(exportDocument(matched, ExportFormat::Png, ExportTargetSpace::Rec709Srgb,
                         ExportBitDepth::Sixteen)
              .ok,
  ...
  // --- JPEG has no alpha channel: refused by name, not silently dropped ---
  {
    ...
    const ExportResult enc = exportDocument(translucent, ExportFormat::Jpeg,
                                            ExportTargetSpace::Rec709Srgb,
                                            ExportBitDepth::Eight);
    ...
    check(exportDocument(translucent, ExportFormat::Png, ExportTargetSpace::Rec709Srgb,
                         ExportBitDepth::Eight)
                  .ok &&
              exportDocument(translucent, ExportFormat::Tga, ExportTargetSpace::Rec709Srgb,
                             ExportBitDepth::Eight)
                  .ok &&
              exportDocument(translucent, ExportFormat::Bmp, ExportTargetSpace::Rec709Srgb,
                             ExportBitDepth::Eight)
                  .ok,
  ...
  // decodes back ------------------------------------------------------------
  {
    ...
    struct Case { ExportFormat format; const char* name; float tol; };
    ...
    const Case cases[] = {
        {ExportFormat::Png, "PNG", kRoundTripTol8},
        {ExportFormat::Tga, "TGA", kRoundTripTol8},
        {ExportFormat::Bmp, "BMP", kRoundTripTol8},
        {ExportFormat::Jpeg, "JPEG", 0.02f},
    };
    for (const Case& c : cases) {
      const ExportResult enc =
          exportDocument(flat, c.format, ExportTargetSpace::Rec709Srgb, ExportBitDepth::Eight);
      char label[96];
  ...
  // --- flattenDocumentToLinear on its own ---------------------------------
  {
    ...
    const ExportResult blankEnc = exportDocument(blank, ExportFormat::Png,
                                                 ExportTargetSpace::Rec709Srgb,
                                                 ExportBitDepth::Sixteen);
    ...
    Document empty;
    const ExportResult emptyEnc = exportDocument(empty, ExportFormat::Png,
                                                 ExportTargetSpace::Rec709Srgb,
                                                 ExportBitDepth::Eight);
  ...
  // --- exportDocumentToFile: same bytes, and failures never touch disk ----
  {
    ...
    std::remove(path);
    std::string err;
    const bool wrote = exportDocumentToFile(ramp, path, ExportFormat::Png,
                                            ExportTargetSpace::Rec709Srgb,
                                            ExportBitDepth::Sixteen, &err);
    ...
    if (wrote) {
      ...
      const ExportResult inMemory = exportDocument(ramp, ExportFormat::Png,
                                                   ExportTargetSpace::Rec709Srgb,
                                                   ExportBitDepth::Sixteen);
    ...
    const bool refused = exportDocumentToFile(ramp, refusedPath, ExportFormat::Jpeg,
                                              ExportTargetSpace::Rec709Srgb,
                                              ExportBitDepth::Sixteen, &refusedErr);
