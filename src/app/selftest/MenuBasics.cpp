...
bool runMenuBasicsTest() {
...

  {
    ...
    if (edit != nullptr) {
      ...
      check(pickable == 17,
            "Edit holds exactly seventeen pickable rows -- the eleven D1/D2 additions, "
            "Clear Canvas, Free Transform, the numeric Transform dialog, and PRD D26's "
            "Fill/Stroke/Define Pattern (track `fill`), no more and no fewer");
    }
  }
