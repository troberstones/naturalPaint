...
bool runMenuBasicsTest() {
...

  {
    ...
    if (edit != nullptr) {
      ...
      check(pickable == 16,
            "Edit holds exactly sixteen pickable rows -- the eleven D1/D2 additions, "
            "Clear Canvas, Free Transform, the numeric Transform dialog, and PRD M9's "
            "Paste Into / Paste as New Document, no more and no fewer");
    }
  }
