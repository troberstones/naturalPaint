...
bool runMenuModelTest() {
  ...
  // 100 -> 105: PRD M9's `PasteInto` and `PasteAsNewDocument`, and PRD D26's
  // `Fill`, `Stroke` and `DefinePattern`.
  check(kMenuActionCount == 105,
        "ids: exactly 105 actions -- the original 41-item extraction plus D1/D2's "
        ...
        "Paste Into / Paste as New Document and Fill/Stroke/Define Pattern, so an "
