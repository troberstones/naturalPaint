...
bool runMenuModelTest() {
  ...
  // 113 -> 117: SplitView and MatchZoom (View), DustScratches (Filter) and
  // AdjustShadowsHighlights (Image > Adjustments), counted off the enum.
  check(kMenuActionCount == 117,
        "ids: exactly 117 actions -- the original 41-item extraction plus D1/D2's "
        ...
        "Contrast/Lens Correction, Warp, Split View/Match Zoom, and Dust & "
        "Scratches/Shadows-Highlights, so an item lost in a later edit fails here");
