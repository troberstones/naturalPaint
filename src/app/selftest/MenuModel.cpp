...
bool runMenuModelTest() {
  ...
  // 113 -> 115, track `split`: `SplitView` and `MatchZoom` (View menu),
  // counted off `MenuAction`'s enumerators in this header (116 including
  // `Count`), never by adding 2 to 113.
  check(kMenuActionCount == 115,
        ...
        "Contrast/Lens Correction, Warp, and Split View/Match Zoom, so an item "
