...
bool runVectorStyleTest() {
  ...
  // =======================================================================
  {
    ...
    const PenPressResult r =
        pathEditBeginPen(&st, &shapes, &nextId, PathPoint{10, 20}, 4.0f, false,
                         SelectionCombine::Replace, 1, /*curveMode=*/false, style);
    ...
    pathEditBeginPen(&st, &shapes, &nextId, PathPoint{300, 400}, 4.0f, false,
                     SelectionCombine::Replace, 1, /*curveMode=*/false, VectorStyle{});
  ...
  // under the sabotage.
  {
    ...
    uint64_t nextId = 1;
    PathEditState pe;
    pathEditBeginPen(&pe, &shapes, &nextId, PathPoint{1, 1}, 4.0f, false,
                     SelectionCombine::Replace, 1, false, made);
